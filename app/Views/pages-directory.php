                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-2.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-3.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-4.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-5.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-6.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-7.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-8.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
                                        <h5 class="text-primary font-size-18 mt-0 mb-1">Jerome A. Hebert</h5>
                                        <p class="font-size-12 mb-2">Creative Director</p>
                                        <p class="mb-0">Jerome@veltrix.com</p>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-9.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
                                        <h5 class="text-primary font-size-18 mt-0 mb-1">Adam V. Acker</h5>
                                        <p class="font-size-12 mb-2">Creative Director</p>
                                        <p class="mb-0">Adam@veltrix.com</p>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card directory-card">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <img src="assets/images/users/user-10.jpg" alt="" class="img-fluid img-thumbnail rounded-circle avatar-lg">
                                    <div class="flex-1 ms-3">
